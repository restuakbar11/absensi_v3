...
<!-- ///////////// Js Files ////////////////////  -->
<!-- Jquery -->
<script src="sw-mod/sw-assets/js/lib/jquery-3.4.1.min.js"></script>
<!-- Bootstrap-->
<script src="sw-mod/sw-assets/js/lib/popper.min.js"></script>
<script src="sw-mod/sw-assets/js/lib/bootstrap.min.js"></script>
<!-- Ionicons -->
<script src="https://unpkg.com/ionicons@5.4.0/dist/ionicons.js"></script>
<script src="https://kit.fontawesome.com/0ccb04165b.js" crossorigin="anonymous"></script>
<!-- Base Js File -->
<script src="sw-mod/sw-assets/js/base.js"></script>
<script src="sw-mod/sw-assets/js/sweetalert.min.js"></script>
<script src="sw-mod/sw-assets/js/webcamjs/webcam.min.js"></script>';
...
<script type="text/javascript">
    ...
    function captureimage2(){
        ...
        shutter.play();
            Webcam.snap( function(data_uri) {
            // display results in page
            Webcam.upload(data_uri, './sw-proses?action=lembur&latitude='+latitude+'',
                function(code,text) {
                    $data       =''+text+'';
                    var results = $data.split("/");
                    $results = results[0];
